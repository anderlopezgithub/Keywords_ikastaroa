...
answer = {
    ...
    "request_inscripcion": "¿Sobre qué quieres más información de las inscripciones, de la pre-matrículo o de la matrícula?",
    ...
    "request_contacto" : "Los datos de contacto del centro son: Teléfono: 945 233 714. Email: icjardin@icjardin.net ",
